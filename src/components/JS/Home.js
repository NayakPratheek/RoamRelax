...
function Home() {
    ...
    React.useEffect(() => {
        const typed = new Typed(e2.current, {
            strings: ['<i>Discover the best <u>TIME</u> to book your next stay</i>', '<i>Discover the best <u>PLACE</u> to book your next stay</i>', '<i>Discover the best <u>HOTEL</u> to book your next stay</i>'],
            typeSpeed: 50,
            backSpeed: 20,
            loop: true,
        });
            ...
            <div class="loc">
                <div class="search">
                    ...
                    <div class="inout">
                        ...
                        <label for="checkIn" id='f1'>Check-in</label><br />
                        <input type="date" />
                    </div>
                    <div class="inout">
                        <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="15" height="15"
                        ...
                        <label for="checkIn" id='f1'>Check-out</label><br />
                        <input type="date" />
                    </div>
                    <div class="srch">
